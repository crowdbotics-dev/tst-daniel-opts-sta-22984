...
## Project Structure
    ...
    ├── tst_daniel_opts_sta_22984  # Django project configurations
...
1. Clone this repo and `cd tst_daniel_opts_sta_22984`
...
2. Clone this repo and `cd tst_daniel_opts_sta_22984`
